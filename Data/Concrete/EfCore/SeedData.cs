            ...
            if (context != null)
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(
                        new User { Username = "kaganucar", Name = "Kagan Ucar", Email = "info@kaganucar.com", Password = "123456", Image= "p1.jpg" },
                        new User { Username = "sadikturan", Name = "Sadık Turan", Email = "info@sadikturan.com", Password = "123456", Image= "p2.jpg" }
                    );
                    context.SaveChanges();
                }
